...
export class crearteRelationUserCustomer1653391403948
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`user\` ADD UNIQUE INDEX \`IDX_6c687a8fa35b0ae35ce766b56c\` (\`customerId\`)`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_6c687a8fa35b0ae35ce766b56c\` ON \`user\` (\`customerId\`)`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`user\` DROP INDEX \`IDX_6c687a8fa35b0ae35ce766b56c\``,
    );
